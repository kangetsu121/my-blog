...
description: '作成済みの Multipass インスタンスについて、multipass set を使ってディスク容量、CPU、メモリなどのリソースを後から変更する方法を紹介します。'
publishedAt: '2022-08-29'
updatedAt: '2022-08-29'
tags: ['multipass']
thumbnail: './canonical_aubergine_hex.png'
thumbnailAlt: 'Canonical logo'
---
