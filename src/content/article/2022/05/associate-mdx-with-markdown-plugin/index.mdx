...
description: 'VS Code で MDX ファイルを Markdown として関連付け、Markdown All in One の補完機能などを MDX 編集でも利用する方法を紹介します。'
publishedAt: '2022-05-29'
updatedAt: '2022-05-29'
tags: ['React', 'Markdown', 'VS Code']
thumbnail: './vscode-logo.png'
thumbnailAlt: 'VS Code logo'
---
...
4. `Markdown All in One Associations` などで検索し, `Files: Associations` の `Item` に `*mdx`, `Value` に `markdown` と入力
   ...
   ![settings での入力](./VSCode_settings.png)
