...
description: 'Gatsby に React 17 以降の新しい JSX Transform を導入し、旧方式とのビルド時間、バンドルサイズ、Lighthouse の結果を比較します。'
publishedAt: '2022-05-28'
updatedAt: '2022-05-28'
tags: ['React', 'GatsbyJS']
thumbnail: './react-logo.png'
thumbnailAlt: 'React logo'
---
...
![旧方式の Unused JavaScript](./lighthouse-score_old_transformation.png)

**新方式:**

![新方式の Unused JavaScript](./lighthouse-score_new_transformation.png)
